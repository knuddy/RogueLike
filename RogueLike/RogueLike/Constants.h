...
public:
	...
	static const int MIN_ROOM_SIZE = 10;
	...
	//Treasure
	static const int NUMBER_OF_TREASURE = 50;
	...
	//NPCS
	static const int NUMBER_OF_NPCS = 15;
	...
	static const int LOG_SPRITE_START_HEALTH_INCREASE = 5;
	...
	static const int INFECTED_SPRITE_START_DAMAGE = 5;
	...
	//Items
	static const int NUMBER_OF_ITEMS = 25;
	...
	static const int RANDOM_SPRITE_CHANCE = 100;
	static const int INFECTED_SPRITE_CHANCE = 50;
	static const int RANDOM_TRESAURE = 100;
	static const int RANDOM_TRESAURE_MIN = 25;
	static const int RANDOM_TRESAURE_HIGH_CHANCE = 25;
	static const int RANDOM_TRESAURE_MID_CHANCE = 70;
	static const int RANDOM_TRESAURE_LOW_CHANCE = 95;

	static const int RANDOM_ITEM = 100;
	static const int RANDOM_ITEM_MIN = 50;
	static const int RANDOM_ITEM_MID_CHANCE = 75;
	static const int RANDOM_ITEM_LOW_CHANCE = 95;

	//NonCombatNPC

	static const int RANDOM_STATE_NUMBER = 1000;
	static const int RANDOM_STATE_CHANCE = 900;
	static const int RANDOM_STATE_CHANCE_DIRECTION = 30;
	static const int RANDOM_STATE_CHANCE_TO_PATROL = 100;
	static const int SLEEP_TICK_LIMIT = 100;
	static const int PATROL_TICK_LIMIT = 200;

	//projectile

	static const int PROJECTILE_MAX_DISTANCE = 3;
	static const int PROJECTILE_MIN_DISTANCE = -3;

	//FOW

	static const int FOG_WIDE = 18;
	static const int FOG_HIGH = 12;
	static const int FOG_OFFSET_ROW = 5;
	static const int FOG_OFFSET_COL = 8;
